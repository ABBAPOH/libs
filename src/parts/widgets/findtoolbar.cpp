...
void FindToolBar::setupActions()
{
    ...
    d->caseSensitiveAction->setIcon(QIcon(QLatin1String(":/parts/icons/casesensitively.png")));
    d->caseSensitiveAction->setCheckable(true);
    d->caseSensitiveAction->setChecked(false);

    d->wholeWordAction = new QAction(this);
    d->wholeWordAction->setIcon(QIcon(QLatin1String(":/parts/icons/wholewords.png")));
    d->wholeWordAction->setCheckable(true);
    d->wholeWordAction->setChecked(false);

    d->regularExpressionAction = new QAction(this);
    d->regularExpressionAction->setIcon(QIcon(QLatin1String(":/parts/icons/regexp.png")));
...
void FindToolBar::setupUi()
{
    ...
    d->findLineEdit->setButtonPixmap(FancyLineEdit::Left, QPixmap(":/parts/icons/magnifier.png"));
...
//    d->closeButton->setStyleSheet("background-color:rgba(0,0,0,0);");
    d->closeButton->setIcon(QIcon(QLatin1String(":/parts/icons/cancelfind.png")));
