...
*/
void IFind::highlightAll(const QString &/*txt*/, FindFlags /*findFlags*/)
{
}
...
*/
void IFind::replace(const QString &/*before*/, const QString &/*after*/, IFind::FindFlags /*findFlags*/)
{
}
...
*/
bool IFind::replaceStep(const QString &/*before*/, const QString &/*after*/, IFind::FindFlags /*findFlags*/)
{
    return false;
}
