    ...
    q_ptr(qq)
{
    ...
    QObject::connect(undoStack, SIGNAL(indexChanged(int)), this, SLOT(undoIndexChanged(int)));
}
...
QRect ImageViewPrivate::selectedImageRect() const
{
    ...
    QRectF result = QRectF(selectionRect.intersected(pixmapRect));
...
void ImageViewPrivate::drawSelection(QPainter *p)
{
    ...
    QRect imageSelectionRect = imageRect.intersected(selectionRect);
...
void ImageViewPrivate::createActions()
{
    ...
    q->connect(actions[ImageView::MoveTool], SIGNAL(triggered(bool)), this, SLOT(onMoveToolTriggered(bool)));
    ...
    q->connect(actions[ImageView::SelectionTool], SIGNAL(triggered(bool)), this, SLOT(onSelectionToolTriggered(bool)));
